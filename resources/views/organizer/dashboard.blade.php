...
@section('content')
    ...
    <div class="row mt-4">
        <form method="GET" action="{{ route('organizer.dashboard') }}" class="row g-3 mt-3 mb-3">
            <div class="col-md-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <form method="GET"
                    ...
                    <input type="text"
                        ...
                        value="{{ $search ?? '' }}"
                        class="form-control"
                        placeholder="Tìm tên, email, SĐT, sự kiện"
                        style="width:280px;">
                    ...
                    <a href="{{ route('organizer.dashboard') }}" class="btn btn-secondary px-3">
                        Xóa
                    </a>

                    <a href="{{ route('organizer.dashboard.exportExcel', request()->query()) }}"
